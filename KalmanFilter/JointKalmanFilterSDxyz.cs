...
{
    public class JointKalmanFilterSDxyz : IJointKalmanFilter
    {
        /// <summary>
        /// 6
        /// </summary>
        ...
        private const double ERRORcovX = 0.09;
        private const double ERRORcovY = 0.04;
        private const double ERRORcovZ = 0.09;
        ...
        public JointKalmanFilterSDxyz(JointCreater jointCreater, MatrixCreater matrixCreater)
        {
